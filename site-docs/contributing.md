...
使用 [Bug 报告模板](https://github.com/SnowCore8/linux-firewall-kmod/issues/new) 提交 Issue，包含：
- 环境信息（内核版本、发行版、项目版本）
- 问题描述和复现步骤
- 预期行为与实际行为
...
使用 [功能请求模板](https://github.com/SnowCore8/linux-firewall-kmod/issues/new) 提交 Issue，说明：
- 功能描述和使用场景
- 替代方案（如有）
- 参考实现或设计思路
