...
[![License](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/SnowCore8/linux-firewall-kmod/blob/master/LICENSE)
...
本项目采用 [MIT License](https://github.com/SnowCore8/linux-firewall-kmod/blob/master/LICENSE) 开源协议。

## 贡献

欢迎通过 [GitHub Issues](https://github.com/SnowCore8/linux-firewall-kmod/issues) 或 [Pull Requests](https://github.com/SnowCore8/linux-firewall-kmod/pulls) 参与贡献。
