...
- [配置指南](CONFIGURATION.md) — YAML 配置格式、参数详解、热重载
- [运维操作手册](OPERATIONS.md) — 安装部署、procfs 接口、故障排查
- [架构设计文档](ARCHITECTURE.md) — 内核模块设计、守护进程设计
- [永久封禁指南](PERMANENT_BAN_GUIDE.md) — SQLite 持久化、数据库维护
