...
> 详细对比请参考 [从 fail2ban 迁移指南](../getting-started/migration.md)。
...
| 数据库（MySQL/Redis）防护 | 封禁 IP 数量超过 4096 的场景 |
...
| 限制 | 说明 | 影响 |
|------|------|------|
| 封禁容量 | 最多 4096 个 IP | 大规模攻击场景可能不够用 |
...
请参考 [从 fail2ban 迁移指南](../getting-started/migration.md)，包含完整的迁移步骤。
